...
export function createTask(title, duration, date, priority) {
  return dispatch => {
    taskList.push({completed: false, title, duration, date, priority})
...
export function updateTask(task, changes, date, priority) {
  return dispatch => {
